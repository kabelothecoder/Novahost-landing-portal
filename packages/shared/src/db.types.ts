/**
 * Supabase-generated database types for project `epulmnfbxjmaimefhofp` (MetaHost).
 * Shared by both apps (one backend).
 *
 * Regenerate after a schema change:
 *   supabase gen types typescript --project-id epulmnfbxjmaimefhofp \
 *     > packages/shared/src/db.types.ts
 * (or the Supabase MCP `generate_typescript_types`). Do not hand-edit.
 */
    ...
    Tables: {
      ...
      signals: {
        Row: {
          ...
          order_type: string
          pair: string | null
          pending_expiry_seconds: number | null
          price: number | null
          side: string | null
